...
class RetrofitBuilder(
    ...
    val libroApiService: LibroApiService = getRetrofit(BASE_URL_LIBROS).create(LibroApiService::class.java)
    ...
    companion object {
        ...
        private const val BASE_URL_LIBROS = "https://openlibrary.org/"
    }
}
